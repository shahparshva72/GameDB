...
struct SummarySection: View {
    ...
    var body: some View {
        GroupBox(label: Text("Summary").fontWidth(.expanded)) {
            if summary.isEmpty {
...
struct StorylineSection: View {
    ...
    var body: some View {
        GroupBox(label: Text("Storyline").fontWidth(.expanded)) {
...
struct ScreenshotsSection: View {
    ...
    var body: some View {
        Section(header: Text("Screenshots").fontWidth(.expanded)) {
            if urls.isEmpty {
...
struct VideosSection: View {
    ...
    var body: some View {
        Section(header: Text("Videos").fontWidth(.expanded)) {
            if videoIDs.isEmpty {
